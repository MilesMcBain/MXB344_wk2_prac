...
Install with `install.packages("dplyr", "ggplot2", "readr", )`.

#Instructions

**Note** The R code in this prac may look different to what you have encountered before. If so, Great! You're going to learn something. Feel free to ask for an explanation of **ANYTHING** no matter how trivial it may seem in the practical session. This online text is a very useful resource for the concepts covered here: [data transformation with dplyr](http://r4ds.had.co.nz/transform.html) in *R for Data Science* by Hadley Wickham. 
